        ...
        try {
            ...
            if (res.ok) {
                setFormData(prev => ({
                    ...prev,
                    ...data,
                    // Preserve defaults if API returned undefined/null for some reason, 
                    // though our API should handle this.
                    technicalScores: prev.technicalScores,
                    rating: prev.rating // User wants to set this manually
                }));
            } else {
            ...
            console.error(error);
            alert('Error importing from IMDb');
        } finally {
    ...
    return (
        <div className="max-w-[1400px] mx-auto">
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl font-heading">Add New Movie</h1>
            ...
            <div className="bg-[#111] p-6 rounded-xl border border-gray-800 mb-8">
                <h2 className="text-xl font-bold mb-4 text-white">Import from IMDb</h2>
                <div className="flex gap-4">
                    <input
                        type="text"
                        placeholder="Paste IMDb URL (e.g. https://www.imdb.com/title/tt...)"
                        value={imdbUrl}
                        onChange={(e) => setImdbUrl(e.target.value)}
                        className="flex-1 bg-[#222] border border-gray-700 rounded p-3 text-white focus:border-accent outline-none"
                    />
                    <button
                        type="button"
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <section className="bg-white/[0.03] p-8 rounded-[32px] border border-white/5 backdrop-blur-md">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {Object.keys(formData.technicalScores!).map(key => (
                                <div key={key}>
